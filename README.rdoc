...
3. As a user I want to be able to create a new trivia fact.
...
9. As a user I want to be able to write a comment on a trivia show page
  so that I may be able to correct the answer or simply express my opinion of it.
  # I can visit a trivia show page and see a form to write a comment.
  # If I fill out the form with valid input I stay on the page and get a confirmation message.
  # If I fill out the form with invalid input I get an error message.

10. As an admin I can visit a page with all the unstaged trivia facts and view them.
...
11. As an admin I can visit a trivia's show page and edit the content
...
12. As an admin I should be able to delete trivia if I know it to be false.
