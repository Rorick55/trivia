[![Build Status](https://travis-ci.org/<Rorick55>/<trivia>.svg?branch=master)](https://travis-ci.org/<Rorick55>/<trivia>) [![Code Climate](https://codeclimate.com/github/<Rorick55>/<trivia>.png)](https://codeclimate.com/github/<Rorick55>/<trivia>) [![Coverage Status](https://coveralls.io/repos/<Rorick55>/<trivia>/badge.png)](https://coveralls.io/r/<Rorick55>/<trivia>)
